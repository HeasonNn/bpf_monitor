...
static void stats_print(struct stats_record *stats_rec,
...

  {
    ...
    printf(fmt, rec->total.rx_packets, pps, rec->total.rx_bytes / 1000, mbps,
           period);
    ...
    sendto(sock_info->sockfd, sock_info->buffer, strlen(sock_info->buffer), 0,
           (const struct sockaddr *)&sock_info->servaddr,
